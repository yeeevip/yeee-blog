  ...
  <article>
    ...
    <h1 class="t_nav">
      ...
      <a
        ...
        v-if="blogData.classify.id"
        @click="goToSortList(blogData.classify.id)"
        class="n2"
      >{{blogData.classify ? blogData.classify.name:""}}</a>
    </h1>
    <div class="infosbox">
      <div class="newsview">
        <h3 class="news_title" v-if="blogData.title">{{blogData.title}}</h3>
        <div class="bloginfo" v-if="blogData.classify.id">
          <ul>
            <li class="author">
        ...
        <div class="tags">
          <a
            v-if="blogData.labelList"
            v-for="item in blogData.labelList"
            :key="item.id"
            href="javascript:void(0);"
