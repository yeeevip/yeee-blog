<template>
  <div class="errPage-container">
    ...
    <el-row>
      <el-col :span="12">
        <h1 class="text-jumbo text-ginormous">500!</h1>
        <h2>网站正在维护中...</h2>
        <h4>请联系博主尽快恢复~</h4>
        <ul class="list-unstyled">
          ...
          <li class="link-type"><a href="https://gitee.com/moxi159753/yeee_blog_v2">一页の博客源码</a></li>
          <li class="link-type"><a href="http://moxi159753.gitee.io/yeee_blog_doc">一页の博客文档</a></li>
