 ...
 */
@Component
public class ArticleClickSinkHandle extends AbstractSinkHandle {
    ...
    public void sink(List<BlogStatsRequest> data) {
        ...
        blogIdMap.forEach((blogId, d) -> {
            apiBlogArticleService.incrBlogReadNum(blogId, d.size());
    ...
    public String genAccessLogRemark(BlogAccessLog save) {
        ...
        return StrUtil.format("用户{}[{}]‘点击’了文章‘{}’", save.getClientIp(), save.getClientAddress(), articleDetailVo.getTitle());
    }
}
