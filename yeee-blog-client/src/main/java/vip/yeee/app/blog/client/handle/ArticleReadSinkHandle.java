 ...
 */
@Component
public class ArticleReadSinkHandle extends AbstractSinkHandle {
    ...
    public String genAccessLogRemark(BlogAccessLog save) {
        ...
        return StrUtil.format("用户{}[{}]‘阅读’了文章‘{}’", save.getClientIp(), save.getClientAddress(), articleDetailVo.getTitle());
    }
}
